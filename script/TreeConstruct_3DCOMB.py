...
for t in swiss_trees:
    ...
    os.system(f'mkdir -p ../deepalign3DCOMB')
    if not os.path.exists(folder+'/deepalign3DCOMB/aln.ali'):
        os.system(f'3DCOMB -i ../pdb.list -o ../deepalign3DCOMB/aln')
        os.system("sed -i 's/.pdb//g' ../deepalign3DCOMB/aln.ali")
    if not os.path.exists(folder+'/deepalign3DCOMB/deepalign3DCOMB_tree.nhx'):
        os.system(f'FastTree ../deepalign3DCOMB/aln.ali > ../deepalign3DCOMB/deepalign3DCOMB_tree.nhx')
    swisst = pickle.load(open(folder+'/swiss_toytree.pkl','rb'))
    out_tree_kernel = folder + '/deepalign3DCOMB/deepalign3DCOMB_tree.nhx'
