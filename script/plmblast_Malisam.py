...
for folder in folderlist:
    ...
    seq1 = str(list(SeqIO.parse(f'../../MalisamFasta/{q}.fasta', format='fasta'))[0].seq)
    seq2 = str(list(SeqIO.parse(f'../../MalisamFasta/{t}.fasta', format='fasta'))[0].seq)
    
    emb1 = torch.load(f'../../Malisam_plmblast_pt/{q}.pt').numpy()
    emb2 = torch.load(f'../../Malisam_plmblast_pt/{t}.pt').numpy()
